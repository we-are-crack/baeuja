...
public class LearningService {
     ...
     */
    public LearningAllContentsResponse findAllContents(int pageSize) {
     ...
     */
    public PagedResponse<LearningContentDto> findContents(Classification classification, int pageNumber, int pageSize) {
