...
import com.eello.baeuja.ui.screen.learning.common.mapper.toLearningContentDetailUiModel
...
class LearningContentDetailViewModel @Inject constructor(
    ...
    fun loadDetailInfo(contentId: Long) {
        Timber.Forest.d("${contentId}에 대한 상세 정보 로드...")
        ...
        viewModelScope.launch {
            try {
                ...
                Timber.Forest.e(e, "상세 정보 로드 실패: ${e.message}")
            } finally {
