...
@Composable
fun VisualContentUniMetaRow(
    contentUnit: ContentUnitUiModel.VisualUnitUiModel
) {
    ...
    Column(
        ...
        Row(
            ...
            Row(
                ...
                Text(
                    text = when (contentUnit.sentenceType) {
                        SentenceType.FAMOUS_LINE -> "Famous Line"
                        SentenceType.CONVERSATION -> "Conversation"
                    },
                    fontFamily = RobotoFamily,
                    fontWeight = FontWeight.Normal,
                    fontSize = 16.sp,
